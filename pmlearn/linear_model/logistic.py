...
class LogisticRegression(BayesianModel, BayesianLinearClassifierMixin):
    """Bayesian Logistic Regression built using PyMC
    ...
    def create_model(self):
        ...
        with model:
            alpha = pm.Normal('alpha', mu=0, sigma=100,
                              shape=(self.num_cats,))
            betas = pm.Normal('beta', mu=0, sigma=100,
...
class HierarchicalLogisticRegression(BayesianModel,
    ...
    """
    Custom Hierachical Logistic Regression built using PyMC.
    """
    ...
    def create_model(self):
        ...
        with model:
            ...
            alpha = pm.Normal('alpha', mu=mu_alpha, sigma=sigma_alpha,
                              shape=(self.num_cats,))
            betas = pm.Normal('beta', mu=mu_beta, sigma=sigma_beta,
                              shape=(self.num_cats, self.num_pred))
